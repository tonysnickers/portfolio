export const projectsData = [
  ...
  },
  {
    ...
    infos:
      "Cette application permet aux cinéphiles de gagner de temps dans leurs recherches de film, grâce à un questionnaire et à un algorithme qui traite les réponses de chaque participant, cette application permet de trouver les films les plus à même de satisfaire les goûts de tout le monde. ",
  ...
  },
  {
    ...
    languages: ['Ruby On Rails', 'Javascript', 'Boostrap', 'HTML', 'CSS'],
    infos:
      'Ce site a été réalisé avec trois camarades de formation. Furnitures Finder est un site de location de meuble, il permet aux particuliers de louer ou de mettre en location leurs meubles.',
